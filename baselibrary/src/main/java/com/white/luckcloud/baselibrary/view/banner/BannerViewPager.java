package com.white.luckcloud.baselibrary.view.banner;
...
public class BannerViewPager extends ViewPager {
    ...
    private com.white.luckcloud.baselibrary.view.banner.BannerAdapter mAdapter;
    // 自定义的改变页面切换速度的Scroller类
    private com.white.luckcloud.baselibrary.view.banner.BannerScroller mScroller;
    ...
    private boolean mAutoScroll = true;// 是否自动滚动
    ...
    public void setAutoScroll(boolean canAutoScroll) {
        this.mAutoScroll = canAutoScroll;
    }
