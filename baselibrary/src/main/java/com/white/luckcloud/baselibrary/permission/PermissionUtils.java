package com.white.luckcloud.baselibrary.permission;
...
public class PermissionUtils {
    ...
    public static void externalStorage(FragmentActivity activity, PermissionCallback permissionCallback) {
        requestPermissions(activity, permissionCallback, com.white.luckcloud.baselibrary.permission.PermissionConfig.STORAGE);
    }
