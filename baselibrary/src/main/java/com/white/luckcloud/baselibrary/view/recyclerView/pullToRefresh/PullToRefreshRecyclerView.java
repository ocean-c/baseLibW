package com.white.luckcloud.baselibrary.view.recyclerView.pullToRefresh;
...
import com.white.luckcloud.baselibrary.view.recyclerView.wrap.WrapRecyclerView;
...
public class PullToRefreshRecyclerView extends WrapRecyclerView {
    ...
    public void addLoadViewCreator(com.white.luckcloud.baselibrary.view.recyclerView.pullToRefresh.LoadViewCreator loadCreator) {
     ...
     * 获取上拉加载的FooterView
     */
    public com.white.luckcloud.baselibrary.view.recyclerView.pullToRefresh.LoadViewCreator getLoadViewCreator() {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mRefreshView != null) {
                    // 按下的时候获取当前的顶部margin
                    mPressMarginTop = ((MarginLayoutParams) mRefreshView.getLayoutParams()).topMargin;
                }
                break;
...
//            }
    ...
    class RecyclerScrollViewListener extends OnScrollListener {
        @Override
        ...
        public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
            if (mScrollChangeListener != null) {
                mScrollChangeListener.onScrollStateChanged(recyclerView, newState);
            }
