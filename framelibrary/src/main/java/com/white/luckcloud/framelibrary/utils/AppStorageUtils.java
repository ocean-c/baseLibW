package com.white.luckcloud.framelibrary.utils;

import android.content.Context;

import com.white.luckcloud.baselibrary.base.BaseApplication;
import com.white.luckcloud.baselibrary.utils.StorageUtils;
...
public class AppStorageUtils {
    ...
    public static String getMediaDownLoadDir(Context context) {
        if (StorageUtils.SdCardAvailable() && StorageUtils.hasExternalStoragePermission(context)) {
            return downLoadPath(context) + File.separator + "media";
        } else {
            return StorageUtils.dataFilesPath(context) + File.separator + "media";
        }
    }
    ...
    public static String getTempVideoDir(Context context) {
        if (StorageUtils.SdCardAvailable() && StorageUtils.hasExternalStoragePermission(context)) {
            return downLoadPath(context) + File.separator + "video";
        } else {
            return StorageUtils.dataFilesPath(context) + File.separator + "video";
        }
    }
    ...
    public static String getPackageCacheDir(Context context) {
        if (StorageUtils.SdCardAvailable() && StorageUtils.hasExternalStoragePermission(context)) {
            return downLoadPath(context) + File.separator + "cache";
        } else {
            return StorageUtils.dataFilesPath(context) + File.separator + "cache";
        }
    }
