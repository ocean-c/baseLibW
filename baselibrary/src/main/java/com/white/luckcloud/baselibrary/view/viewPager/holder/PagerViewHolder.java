package com.white.luckcloud.baselibrary.view.viewPager.holder;
...
/**
 * ViewPager使用的ViewHolder
 * Created by fa on 2019/7/1.
 */
...
public class PagerViewHolder {
     ...
     * 设置TextView文本
     */
    public PagerViewHolder setText(int viewId, CharSequence text) {
     ...
     * 设置View的Visibility
     */
    public PagerViewHolder setViewVisibility(int viewId, int visibility) {
     ...
     * 设置ImageView的资源
     */
    public PagerViewHolder setImageResource(int viewId, int resourceId) {
     ...
     * 也可以直接写死
     */
    public PagerViewHolder setImageByUrl(int viewId, HolderImageLoader imageLoader) {
        ImageView imageView = getView(viewId);
        if (imageLoader == null) {
