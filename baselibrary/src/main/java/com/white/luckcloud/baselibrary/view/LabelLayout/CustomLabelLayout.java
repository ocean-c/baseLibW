package com.white.luckcloud.baselibrary.view.LabelLayout;
...
import com.white.luckcloud.baselibrary.entity.SelectEntity;
...
public class CustomLabelLayout extends ViewGroup {
    ...
    private int mMaxSelectSize = -1;// 最多选择的数量
    private int mSelectSize = 0;// 当前选择的数量
...
//        LogUtils.e(TAG, "mLabelRowSpace=" + mLabelRowSpace + "   mLabelSpace=" + mLabelSpace);
    ...
    public void setMaxSelectSize(int maxSelectSize) {
        this.mMaxSelectSize = maxSelectSize;
    }
    ...
    private class MyClickListener implements OnClickListener {
        ...
        public void onClick(View view) {
            ...
            // 判断是否到了最大选择数量
            if (mMaxSelectSize != -1 && mSelectSize >= mMaxSelectSize) {
                LogUtils.e(TAG, "到了最大可选择数量，当前选中数量为：" + mSelectSize);
                return;
            }
            // 选择数量计数(当前状态是非选中，点击之后计数加1)，选中数量小于最大限制数量的时候才加1，否则会一直加
            if (mSelectSize < mMaxSelectSize && !view.isSelected()) {
                mSelectSize++;
            }
