package com.white.luckcloud.framelibrary.navigationBar;
...
import com.white.luckcloud.baselibrary.utils.ViewUtils;
import com.white.luckcloud.baselibrary.view.navigationbar.AbsNavigationBar;
...
public class DefaultNavigationBar<D extends DefaultNavigationBar.Builder.DefaultNavigationParams>
    ...
    public void setRightTextSize(int textSize) {
        ...
        ViewUtils.setTextSizeDP(textView, textSize);
    }
     ...
     */
    public void showContentTopShadow(boolean state) {
        D params = (D) getParams();
        params.mShowContentTopShadow = state;
        if (state) {
            setContentTopShadow(params);
        }
    }
