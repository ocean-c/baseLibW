package com.white.luckcloud.baselibrary.view.picker;
...
import com.white.luckcloud.baselibrary.R2;
...
public class DatePickerView extends LinearLayout implements PickerView.OnSelectListener {
    ...
    public boolean setSelectedTime(String dateStr, boolean showAnim) {
        return !StringUtils.isEmpty(dateStr)
                && setSelectedTime(com.white.luckcloud.baselibrary.view.picker.DateFormatUtils.str2Long(dateStr, mCanShowPreciseTime), showAnim);
    }
