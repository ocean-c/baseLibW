package com.white.luckcloud.framelibrary.update;
...
import com.white.luckcloud.baselibrary.base.BaseActivity;
import com.white.luckcloud.baselibrary.dialog.AlertDialog;
import com.white.luckcloud.baselibrary.http.HttpUtils;
import com.white.luckcloud.baselibrary.utils.AppInstallUtils;
...
import com.white.luckcloud.framelibrary.commom.Constants;
...
import com.white.luckcloud.framelibrary.http.callback.DefaultHttpCallback;
import com.white.luckcloud.framelibrary.utils.AppStorageUtils;
...
public class UpdateUtils {
    ...
    private void showUpdateDialog() {
        ...
        mUpdateDialog.setText(R.id.tv_dialog_update_desc, mUpdateEntity.getVersionDesc());
        // 判断是不是需要强制更新
        if (mUpdateEntity.isForceUpdate()) {
    ...
    private void showDownLoadNotification() {
        ...
        mBuilder.setContentTitle(AppUtils.getAppName(mContext) + "版本更新") //设置通知标题
                .setSmallIcon(R.mipmap.ic_launcher_small) //设置通知的小图标
