...
import com.white.luckcloud.baselibrary.view.recyclerView.adapter.CommonRecyclerAdapter;
import com.white.luckcloud.baselibrary.view.recyclerView.adapter.MultiTypeSupport;
import com.white.luckcloud.baselibrary.view.recyclerView.holder.ViewHolder;
import com.white.luckcloud.baselibrary.view.recyclerView.pullToRefresh.PullToRefreshRecyclerView;
import com.white.luckcloud.framelibrary.R;
import com.white.luckcloud.framelibrary.entity.BaseListEntity;
import com.white.luckcloud.framelibrary.view.DefaultLoadView;
import com.white.luckcloud.framelibrary.view.DefaultRefreshView;
...
public abstract class BaseListFragment<ShowData extends BaseListEntity, Request> extends FrameBaseFragment {
     ...
     * 获取泛型类型，并构建实体
     */
    protected ShowData createShowData() {
        try {
